# IMPORTANT: the code shown below was made by Shengbin Meng and can be found at https://github.com/shengbinmeng/Bjontegaard_metric/blob/master/bjontegaard_metric.py
